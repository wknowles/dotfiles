...
# username in twitter_config which has not been committed to git
#TWITTER_USER = "username"
MAX_AGE_IN_DAYS = 14 # anything older than this is deleted

# these are found in twitter_config which has not been committed to git
